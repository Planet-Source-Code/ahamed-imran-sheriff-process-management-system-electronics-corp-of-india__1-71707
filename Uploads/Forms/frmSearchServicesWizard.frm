...
Begin VB.Form frmSearchServicesWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmSearchServicesWizard.frx":0000
      Left            =   1680
      List            =   "frmSearchServicesWizard.frx":000A
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmSearchServicesWizard.frx":0028
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmSearchServicesWizard.frx":00CA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmSearchServicesWizard.frx":0168
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmSearchServicesWizard"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsServicesMaintenance.RecordCount > 0 Then
        ...
        With rsServicesMaintenance
            ...
            frmServiceTreatmentsOut.txtServiceID.Text = .Fields(0).Value
            frmServiceTreatmentsOut.txtServiceName.Text = .Fields(1).Value
            frmServiceTreatmentsOut.txtServiceCharge.Text = .Fields(2).Value
