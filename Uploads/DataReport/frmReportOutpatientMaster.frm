...
Begin VB.Form frmReportOutpatientMaster 
   ...
   End
End
Attribute VB_Name = "frmReportOutpatientMaster"
...
Private Sub cmdOK_Click()
    On Error GoTo e
        ...
        endDate = txtdate2.Text
                ...
                DataEnvironment1.Commands("OutpatientMaintenanceMaster").Parameters(0) = txtdate1
                DataEnvironment1.Commands("OutpatientMaintenanceMaster").Parameters(1) = txtdate2
                With RptOutpatientMaster
                ...
                .Show
            End With
            DataEnvironment1.rsOutpatientMaintenanceMaster.Close
