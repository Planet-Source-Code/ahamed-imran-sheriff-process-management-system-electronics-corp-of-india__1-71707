...
Begin VB.Form frmReportOutpatientMedicalTreatments 
   ...
   End
End
Attribute VB_Name = "frmReportOutpatientMedicalTreatments"
...
Private Sub cmdOK_Click()
    On Error GoTo e
        ...
        endDate = txtdate2.Text
                ...
                DataEnvironment1.Commands("OUTPatientMedicalTreatements").Parameters(0) = txtdate1
                DataEnvironment1.Commands("OUTPatientMedicalTreatements").Parameters(1) = txtdate2
                With RptOUTPatientMedicalTreatment
                ...
                .Show
            End With
            DataEnvironment1.rsOUTPatientMedicalTreatements.Close
