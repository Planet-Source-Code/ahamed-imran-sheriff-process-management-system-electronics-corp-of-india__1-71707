...
Begin VB.Form frmReportInpatientRevenue 
   ...
   Begin VB.Frame frmReportInpatientRevenue 
   ...
   End
End
Attribute VB_Name = "frmReportInpatientRevenue"
...
Private Sub cmdOK_Click()
    On Error GoTo e
        ...
        endDate = txtdate2.Text
                ...
                DataEnvironment1.Commands("InpatientRevenue").Parameters(0) = txtdate1
                DataEnvironment1.Commands("InpatientRevenue").Parameters(1) = txtdate2
                With RptInpatientRevenue
                    .Sections("Section2").Controls("lblDate1").Caption = txtdate1.Text
                    .Sections("Section2").Controls("lblDate2").Caption = txtdate2.Text
                    .Show
            End With
            DataEnvironment1.rsInpatientRevenue.Close
