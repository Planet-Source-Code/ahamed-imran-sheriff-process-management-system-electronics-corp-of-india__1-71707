...
Begin VB.Form frmReportPatientAdmission 
   Caption         =   "Patient Admission Details Report"
   ClientHeight    =   4410
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6660
   ...
   End
End
Attribute VB_Name = "frmReportPatientAdmission"
...
Private Sub cmdOK_Click()
    On Error GoTo e
        ...
        endDate = txtdate2.Text
                ...
                DataEnvironment1.Commands("AdmissionReport").Parameters(0) = txtdate1
                DataEnvironment1.Commands("AdmissionReport").Parameters(1) = txtdate2
                With RptPatientAdmission
                    .Sections("Section2").Controls("lblDate1").Caption = txtdate1.Text
                    .Sections("Section2").Controls("lblDate2").Caption = txtdate2.Text
                    .Show
            End With
            DataEnvironment1.rsAdmissionReport.Close
