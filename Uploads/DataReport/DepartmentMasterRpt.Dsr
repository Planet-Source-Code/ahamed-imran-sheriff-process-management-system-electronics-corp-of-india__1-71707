VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} RptDepartmentMaster 
   Bindings        =   "DepartmentMasterRpt.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   6000
   ClientLeft      =   60
   ClientTop       =   450
   ...
   TopMargin       =   1440
   BottomMargin    =   1440
   DataMember      =   "DepartmentMasterReport"
   NumSections     =   5
   SectionCode0    =   1
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   9360
         Object.Height          =   1299
         Picture         =   "DepartmentMasterRpt.dsx":001F
      EndProperty
      ItemType1       =   3
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BackColor       =   16761024
         BackStyle       =   1
         Object.Caption         =   $"DepartmentMasterRpt.dsx":25B6
      EndProperty
   EndProperty
   SectionCode1    =   2
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   12582912
         Object.Caption         =   "DEPARTMENT MASTER RECORD"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode2    =   4
   ...
   BeginProperty Section4 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Total No. of Departments"
      EndProperty
   EndProperty
End
Attribute VB_Name = "RptDepartmentMaster"
