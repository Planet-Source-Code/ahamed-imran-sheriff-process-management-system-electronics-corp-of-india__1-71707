...
Begin VB.Form frmReportDoctorsEarnings 
   Caption         =   "Doctor Earnings Report"
   ClientHeight    =   4335
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   6600
   ...
   End
End
Attribute VB_Name = "frmReportDoctorsEarnings"
...
Private Sub cmdOK_Click()
    On Error GoTo e
        ...
        DataEnvironment1.Commands("InpatientDoctorsEarnings").Parameters(0) = txtdate1
        DataEnvironment1.Commands("InpatientDoctorsEarnings").Parameters(1) = txtdate2
        With RptInpatientDoctorsEarnings
            .Sections("Section2").Controls("lblDate1").Caption = txtdate1.Text
            .Sections("Section2").Controls("lblDate2").Caption = txtdate2.Text
            .Show
        End With
        DataEnvironment1.rsInpatientDoctorsEarnings.Close
